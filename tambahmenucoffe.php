        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <div class="col-sm-6">
                        <h3><i class="fas fa-plus mt-3"></i> Tambah Data Coffe</h3>
                    </div>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Halaman Tambah Data Coffe</li>
                    </ol>
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="konfirmasitambahcoffe.php" method="post">
                            <div class="card-body">

                                <div class="form-group row mt-2">
                                    <label for="namacoffe" class="col-sm-3 col-form-label">Nama Coffe</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="namacoffe" id="namacoffe" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="hargacoffe" id="hargacoffe" value="">
                                    </div>
                                </div>
