...
if (isset($_GET['data'])) {
    $id_coffe = $_GET['data'];
    $_SESSION['id_coffe'] = $id_coffe;

    //get data kategori blog
    $sql = "select `nama_coffe`, `harga_coffe` from `coffe` where 
	`id_coffe` = '$id_coffe'";
    $query_d = mysqli_query($koneksi, $sql);
    while ($data_d = mysqli_fetch_row($query_d)) {
        $nama_coffe = $data_d[0];
        $harga_coffe = $data_d[1];
    }
}
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <div class="col-sm-6">
                        <h3><i class="fas fa-edit mt-3"></i> Edit Menu Coffe</h3>
                    </div>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Halaman Edit Menu Coffe</li>
                    </ol>
                    <a href="datacoffe.php" class="btn btn-sm btn-warning float-right mb-3"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>

                    <div class="card card-info">
                        <div class="card-header">
                            <i class="fas fa-table mr-1"></i>
                            Form Edit Menu Coffe
                        </div>
                        ...
                        <form class="form-horizontal" action="konfirmasieditcoffe.php" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group row mt-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="namacoffe" id="namacoffe" value="<?php echo $nama_coffe ?>">
                                    </div>
                                </div>

                                <div class="form-group row mt-2">
                                    <label for="hargacoffe" class="col-sm-3 col-form-label">Harga Coffe</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="hargacoffe" id="hargacoffe" value="<?php echo $harga_coffe ?>">
                                    </div>
                                </div>
